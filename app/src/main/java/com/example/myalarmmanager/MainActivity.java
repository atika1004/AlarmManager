...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btn_one_time_alarm_date) {
            ...
            alarmReceiver.setOneTimeAlarm(this, AlarmReceiver.TYPE_ONE_TIME, alarmPreference.getOneTimeDate(), alarmPreference.getOneTimeTime(), alarmPreference.getOneTimeMessage());
        }
            ...
            new TimePickerDialog(this, new TimePickerDialog.OnTimeSetListener() {
                ...
                public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                    ...
                    SimpleDateFormat dateFormat = new SimpleDateFormat("HH:mm");
                    tvRepeatingTime.setText(dateFormat.format(calRepeatingTimeTime.getTime()));
            ...
            SimpleDateFormat timeFormat = new SimpleDateFormat("HH:mm");
            String repeatTimeTime = timeFormat.format(calRepeatingTimeTime.getTime());
